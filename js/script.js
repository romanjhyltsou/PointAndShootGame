  ...
  ravens.forEach(object => {
    if(object.randomColors[0] === pc[0] && object.randomColors[1] === pc[1] &&
      object.randomColors[2] === pc[2]){
        ...
        score++;
        explostions.push(new Explosion(object.x, object.y, object.width));
        console.log(explostions);
    }
  });
});
...
function animate(timestamp) {
  ...
  drawScore();
  [ ...particles, ...ravens, ...explostions].forEach(object => object.update(deltatime));
  [ ...particles, ...ravens, ...explostions].forEach(object => object.draw());
  ravens = ravens.filter(object => !object.markedForDeletion);
  explostions = explostions.filter(object => !object.markedForDeletion);
